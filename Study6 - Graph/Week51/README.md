...
| 사이트 | 번호 | 문제                 | 답안                | 피드백 반영 답안    |
| ------ | ---- | -------------------- | ------------------- | ------------------- |
| 백준   | 17265    | [<sub>![Gold5]</sub> 나의 인생에는 수학과 함께](https://www.acmicpc.net/problem/17265) | [진홍](Day355/boj17265_kjh.java) 승빈 *[수경](Day355/boj17265_hsk.js)* | 진홍 승빈 수경 |
...
| ------ | ---- | -------------------- | ------------------- | ------------------- |
| 백준   | 10707 | [<sub>![Bronze4]</sub> 수도요금](https://www.acmicpc.net/problem/10707) | 진홍 승빈 수경 | 진홍 승빈 수경 |
