...
//// 함수가 하는 일을 함수 이름이 좀 더 설명해줬으면 좋겠어요!
//// 지금은 함수 이름이 dfs인데 반해 깊이 우선 탐색'만'하고있지는 않은 것 같아요: 22
//// : 넹~ 수정하였습니닷
//// 깔끔해요
const getParentNode = (root, connectedNodeList, parentsNodeList) => {
  let nodeList = [root];
...
getParentNode(1, connectedNodeList, parentsNodeList);
