...
//// kjh의 메소드를 참고하여 visualizeAntDent로 변경하겠습니댱
const visualizeAntDent = (trie, depth = 0) => {
  ...
  for (let [keyOfChildTrie, valueOfChildTrie] of sortedTrie) {
    ...
    visualizedStr.push(visualizeAntDent(valueOfChildTrie, depth + 1));
  }
...
const visualizedAntStructure = visualizeAntDent(antTrie);
