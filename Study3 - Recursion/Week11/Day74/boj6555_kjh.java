...
//// => 이전 depth 배열만 저장하기
//// 이건 효율성에 큰 차이가 없습니다
//// https://github.com/deepredk/BCU_Algorithm_Study/blob/main/Week08/Day54/boj16505_kjh.java
...
//// 지금 재귀함수 형태가, 하나의 기저사례로 모든 char들이 매꿔지는 점이 너무 아름다워서 바꾸기 너무 아쉬워요
class Main {
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.print(triangles.stream().map(StringBuilder::toString).collect(joining("\n")));
  }
