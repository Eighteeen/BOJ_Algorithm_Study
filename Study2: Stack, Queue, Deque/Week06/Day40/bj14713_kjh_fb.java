...
class Main {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //// => 확실히 그게 더 자연스러울 것 같습니다 ㅎㅎ 좋은 피드백 감사합니다!
    String[] mixedWords = Input.nextLine().split(" ");
    for (String word : mixedWords) {
      ...
      //// => '얘는 앞에 !가 붙었으니 false가 나와야 true겠구나? 즉 canParrotSay가 false여야겠네.'
      //// => 이런 뇌내 중간연산을 줄이고 싶었고, 또 하나의 영어 문장처럼 자연스럽게 읽혔으면 했어요!
