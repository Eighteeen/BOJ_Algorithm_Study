...
class Main {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //// => 타협의 타협을 거치다보니 전에는 함수로 분리했을 것을 안하게 됐네요 ㅎㅋㅋ
    //// => 피드백 고마워요! 다시어느정도는 신경써야겠어요
    String seatLocation = locateSeat(K);
    System.out.print(seatLocation);
  }

  static String locateSeat(int order) {
  ...
  //// => 전부 만들어버릴까, 아니면 범위를 좁혀가며 찾아야 되나를 처음에 고민했는데
  //// => 입력 값이 작길래 전부 만드는 쪽을 택했습니다! 문제 푸는데에 시간을 적절히 분배하는 것도 효율성과 가독성만큼이나 중요하다고 생각하거든요
