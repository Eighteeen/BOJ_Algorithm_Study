...
public class Test
{
	public static void Main()
	{
		...
		//// 아래 if문을 통째로 지워도 "맞았습니다"로 뜹니다. 문제의 4번 조건이 있어 중복 단어가 들어올 가능성이 없기 때문입니다. : 22
		if (pr.IsDistinct())
		{
		...
		for (int i = 0; i < lineCnt; i++)
		{
			...
			//// 스택/큐/덱을 활용하는 방법을 익히는 것이 이번 주의 주제니 세 자료구조 중 하나는 썼어야 됐을 것 같아요 : 22
...
public class Parrot
{
	...
	//// 유일한가? 라는 함수이름과 다르게 중복인가?에 대한 결과를 반환하네요 : 22 메인에서 의아했습니다
